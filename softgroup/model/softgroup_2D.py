...
class SoftGroup(nn.Module):
    ...
    def __init__(self,
        ...
        self.offset_linear = MLP(channels, 2, norm_fn=norm_fn, num_layers=2)
    ...
    def forward(self, batch,epoch, return_loss=False):
        if return_loss:
    ...
    def forward_train(self, batch_idxs, voxel_coords, p2v_map, v2p_map, coords_float, feats,
        ...
        point_wise_loss = self.point_wise_loss(semantic_scores, pt_offsets, semantic_labels,
                                               instance_labels, pt_offset_labels[:,0:2])
    ...
    def forward_grouping(self,
        ...
        for class_id in range(self.semantic_classes):
            ...
            center=coords_[:,0:2] + pt_offsets_
            ...
            n =torch.zeros(center.size(0),1).cuda()
            center=torch.cat([center,n],dim=1)
