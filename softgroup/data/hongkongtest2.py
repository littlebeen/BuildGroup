...
class HongkongDataset(CustomDataset):
    ...
    def __getitem__(self, index):
        ...
        for block in blocks:
            ...
            all_data.append((scan_id, coord, coord_float,semantic_label, instance_label, feat,xyz_pre,ground_xyz,block))
    ...
    def collate_fn(self, batch):
        ...
        for data in batch:
            for i in range(len(data)):
                ...
                if data[i] is None:
                    continue
                (scan_id, coord, coord_float, semantic_label, instance_label,feat,xyz_pre,ground_xyz,cond) = data[i]
