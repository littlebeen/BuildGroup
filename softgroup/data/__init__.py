...
from .hongkongtest import HongkongDataset
...
def build_dataset(data_cfg, logger):
    ...
    elif data_type == 'urbanbis':
        return UrbanbisDataset(**_data_cfg)
    elif data_type == 'hongkong':
        return HongkongDataset(**_data_cfg)
